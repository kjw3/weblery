			...
			<tr>
				...
				<td valign="top" style="text-align:center;">
					...
					<div id="current-image" onmouseover="javascript:hidePreviewImage();" style="overflow:hidden;">
						<div id="preview-image" onmouseover="javascript:hidePreviewImage();"><img id="preview-image-img" src="<?php echo $selectedAlbumCachePath . "320_" . md5($currentAlbumArray[0]); ?>" style="margin:0 auto;border: 4px solid #fff;" alt="Preview Image" /></div>
