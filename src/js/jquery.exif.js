...
/*
 * Javascript EXIF Reader - jQuery plugin 0.1.1
...
{
	var skippedTags = new Array("Undefined","MakerNote","UserComment");
	...
	for (var i=0;i<iEntries;i++) {
		...
		if (jQuery.inArray(strTag, skippedTags) == -1) {
...
jQuery.fn.exifLoadSingle = function(imageId,fncCallback) {
	return EXIF.getData(document.getElementById(imageId), fncCallback);
}
...
jQuery.fn.exifPrettySingle = function(imageId) {
	var aStrings = [];
	aStrings.push(EXIF.pretty(document.getElementById(imageId)));
	return aStrings;
}
